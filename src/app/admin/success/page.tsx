    ...
    try {
      const response = await fetch('/api/success-stories', {
        ...
        body: JSON.stringify({
          ...
          followed_roadmap_id: parseInt(formData.followed_roadmap_id),
        ...
        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
          ...
          >
            ...
            <form onSubmit={handleCreateStory} className="space-y-4">
              ...
              <div>
                <Label htmlFor="followed_roadmap_id" className={`text-sm font-medium ${theme === 'dark' ? 'text-slate-200' : 'text-slate-700'}`}>
                  Followed Roadmap
                </Label>
                <Select
                  value={formData.followed_roadmap_id}
                  onValueChange={(value) => setFormData({ ...formData, followed_roadmap_id: value })}
                >
                  <SelectTrigger
              ...
              <div className="flex justify-end gap-2">
                ...
                <Button
                  type="submit"
                  disabled={isSubmitting || !formData.followed_roadmap_id}
                  className={`${theme === 'dark' ? 'bg-blue-600 hover:bg-blue-700' : 'bg-blue-600 hover:bg-blue-700'} text-white rounded-lg hover:scale-105 transition-transform`}
                >
